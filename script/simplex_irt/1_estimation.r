...
# Import the datasets 
  ...
  d_wide <- read.csv('./data/simplex_wide.csv')
  d      <- read.csv('./data/simplex_long.csv')
...
# Compile the model
  ...
  mod  <- cmdstan_model('./script/simplex_irt/simplex.stan')
...
# Save the output object
  ...
  save.image("./output/simplex.RData")
